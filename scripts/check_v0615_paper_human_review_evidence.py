...
def _check_repository_version(root: Path, errors: list[str]) -> None:
    ...
    if not source_ok:
        errors.append("Source/package version must match the audited v0.6.15 state (0.6.14, 0.6.15, 0.6.16, 0.6.17, 0.6.18, 0.6.19, 0.6.20, 0.6.21, 0.6.24, 0.6.25, or 0.6.26)")
