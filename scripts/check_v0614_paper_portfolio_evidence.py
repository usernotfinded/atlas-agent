...
def _check_repository_version(root: Path, errors: list[str]) -> None:
    ...
    allowed = (SOURCE_VERSION, POST_RELEASE_SOURCE_VERSION, POST_V0615_SOURCE_VERSION, POST_V0616_SOURCE_VERSION, POST_V0617_SOURCE_VERSION, POST_V0618_SOURCE_VERSION, POST_V0619_SOURCE_VERSION)
