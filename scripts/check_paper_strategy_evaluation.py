...
EXPECTED_SOURCE_VERSION = "0.6.14"
EXPECTED_CURRENT_PUBLIC_TAG = "v0.6.14"
EXPECTED_NEXT_PLANNED_TAG = "v0.6.15"
...
def _check_release_metadata(repo_root: Path, checks: list[CheckResult], findings: list[str]) -> dict[str, Any]:
    ...
    _add(
        ...
        ok=not errors,
        pass_detail="Release metadata is v0.6.14 public / v0.6.15 planning.",
        fail_detail="; ".join(errors),
    )
    return {
