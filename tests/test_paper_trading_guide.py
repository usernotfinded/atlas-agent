...
def test_only_cand_001_through_004_are_implemented() -> None:
    ...
    for candidate_id in ("CAND-005", "CAND-006", "CAND-007", "CAND-008", "CAND-009", "CAND-010"):
    ...
    assert "CAND-005** — Release/checker simplification after v0.6.10 — not implemented" in markdown
