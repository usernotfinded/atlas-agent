...
class TestChangelogStructure:
    ...
    def test_stable_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7.md").exists()

    def test_rc9_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc9.md").exists()
    ...
    def test_rc6_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc6.md").exists()

    def test_rc5_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc5.md").exists()

    def test_rc4_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc4.md").exists()

    def test_rc3_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc3.md").exists()

    def test_rc2_release_note_exists(self) -> None:
        assert (RELEASES_DIR / "v0.5.7-rc2.md").exists()
...
class TestChangelogVersionReferences:
    ...
    def test_previous_rc_version_in_changelog(self, changelog_text: str) -> None:
        assert "[0.5.7rc6]" in changelog_text

    def test_previous_rc_version_in_changelog(self, changelog_text: str) -> None:
        assert "[0.5.7rc5]" in changelog_text
