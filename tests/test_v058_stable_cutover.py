# ==============================================================================
# PROJECT: Atlas Agent
# FILE:    tests/test_v058_stable_cutover.py
# PURPOSE: Verifies v058 stable cutover behavior and regression expectations.
...
CUTOVER_SCRIPT = REPO_ROOT / "scripts" / "historical_release_checkers" / "check_v058_stable_cutover.py"
    ...
    with patch.object(CUTOVER_MOD, "_check_tag_state", _patched_tag_state):
        with patch.object(CUTOVER_MOD, "_check_historical_tag", lambda: []):
            with patch.object(CUTOVER_MOD, "_check_current_version", lambda: []):
                with patch.object(
                    CUTOVER_MOD, "_check_readme_current_status", lambda: []
                ):
                    result = CUTOVER_MOD._gather()
