# ==============================================================================
# PROJECT: Atlas Agent
# FILE:    tests/test_v0581_hotfix_cutover.py
# PURPOSE: Verifies v0581 hotfix cutover behavior and regression expectations.
...
def test_cutover_script_json_output() -> None:
    ...
    assert data["errors"] == []
    assert data["expected_version"] == CUTOVER_MOD.EXPECTED_VERSION
