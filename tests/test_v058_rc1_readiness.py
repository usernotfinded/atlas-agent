# ==============================================================================
# PROJECT: Atlas Agent
# FILE:    tests/test_v058_rc1_readiness.py
# PURPOSE: Verifies v058 rc1 readiness behavior and regression expectations.
...
def test_readiness_script_json_output() -> None:
    ...
    assert data["errors"] == []
    assert data["current_dev_version"] == READINESS_MOD.CURRENT_DEV_VERSION
