...
class TestRealRepoIntegration:
    def test_real_repo_target_v0_5_7_rc1(self) -> None:
        ...
        # Current main is 0.5.9.dev0, so this is a dev version.
    ...
    def test_real_repo_rc_state(self) -> None:
        ...
        # Current main is 0.5.9.dev0 development.
        assert report["current_version_is_dev"] is True
        # dev_to_rc_transition_valid should be False for mismatched versions
        assert report["dev_to_rc_transition_valid"] is False
        # Development-cycle changes are tracked under CHANGELOG [Unreleased], not a dev tag release note.
        assert report["release_note_present"] is False
    ...
    def test_real_repo_release_note_absent_for_current_dev(self) -> None:
        report = build_release_candidate_cutover_dict(REPO_ROOT, "v0.5.7-rc1", "rcc-real-note")
        # Current main is 0.5.9.dev0; no dev tag release note should be required here.
        assert report["release_note_present"] is False
