...
class TestReadmeLinks:
    ...
    def test_readme_current_status_is_v0617(self, readme_text: str) -> None:
        assert "v0.6.17" in readme_text
...
class TestVersionConsistency:
    def test_package_version_is_dev(self) -> None:
        ...
        with open(pyproject, "rb") as f:
            data = tomllib.load(f)
        assert data.get("project", {}).get("version") == "0.6.17"
