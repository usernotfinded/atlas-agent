...
> **Current Status (v0.5.9.dev0)** — `main` is 0.5.9.dev0 development; latest stable public release is [v0.5.8](docs/releases/v0.5.8.md).
...
`v0.5.8` is the latest stable public GitHub Release, promoted from the final green `v0.5.8rc5` release candidate. `main` is now `0.5.9.dev0` development. Unreleased changes belong under `[Unreleased]` in `CHANGELOG.md`. No PyPI publish has been performed.
