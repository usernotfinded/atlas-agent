...
Atlas is in active development on the `main` branch. The v0.6.5 release is the current public GitHub release. v0.6.4 is historical. v0.6.3, v0.6.2, v0.6.1, and v0.6.0 are historical. Security updates are applied to the latest development line.
