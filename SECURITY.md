...
| Version | Supported |
|---|---|
| 0.6.11 (main) | Yes — current public GitHub release |
...
Atlas is in active development on the `main` branch. The source version on main is 0.6.11; this source version is the current public GitHub release.
