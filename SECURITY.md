...
Atlas is in active development on the `main` branch. The v0.5.9 release is the current public stable target. Security updates are applied to the latest development line.
