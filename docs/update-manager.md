...
**Secret Protection**: The update manager is explicitly designed to protect your sensitive local configuration. It will **never** overwrite or modify `.env`, `.env.atlas`, `.env.local`, or your `.atlas/config.toml`.
