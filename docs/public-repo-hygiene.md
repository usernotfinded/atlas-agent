...
Atlas is currently at public release `v0.6.12` (tagged and published), with
`v0.6.11` as the historical previous public release:
- **Package version on `main`:** `0.6.12`
- **Latest public tag:** `v0.6.12`
