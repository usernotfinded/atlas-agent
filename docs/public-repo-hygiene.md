...
Atlas is currently at public release `v0.6.10` (tagged and published), with
`v0.6.11` prepared but not yet public:
- **Package version on `main`:** `0.6.11`
- **Latest public tag:** `v0.6.10`
