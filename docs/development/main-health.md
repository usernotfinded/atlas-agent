...
updates. After the v0.6.19 release, the source package version on `main` is `0.6.19`, the
current public release is `v0.6.19`, and the public GitHub release is `v0.6.19`. The
previous public release is `v0.6.18`. The next planning line is `v0.6.20`.
