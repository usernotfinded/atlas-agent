...
updates. After the v0.6.24 release, the source package version on `main` is `0.6.24`, the
current public release is `v0.6.24`, and the public GitHub release is `v0.6.24`. The
previous public release is `v0.6.23`. The next planning line is `v0.6.25`.
