...
updates. After the v0.6.25 release, the source package version on `main` is `0.6.25`, the
current public release is `v0.6.25`, and the public GitHub release is `v0.6.25`. The
previous public release is `v0.6.24`. The next planning line is `v0.6.26`.
