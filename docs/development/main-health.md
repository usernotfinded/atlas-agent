...
updates. After the v0.6.11 release, the source package version on `main` is `0.6.11`, the
current public release is `v0.6.11`, and the public GitHub release is `v0.6.11`. The
previous public release is `v0.6.10`. The next planning line is `v0.6.12`.
