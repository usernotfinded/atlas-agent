...
| `atlas research provider-adapter-interface-contract PROVIDER_EXECUTION_UNLOCK_STATE_ID` | Create an adapter interface contract artifact from an unlock state | Yes | No | No |
| `atlas research provider-adapter-interface-contract-list` | List adapter interface contract artifacts | No | Yes | No |
| `atlas research provider-adapter-interface-contract-show CONTRACT_ID` | Show an adapter interface contract artifact | No | Yes | No |
| `atlas research provider-adapter-interface-contract-validate CONTRACT_ID` | Validate an adapter interface contract artifact | No | Yes | No |
| `atlas research provider-adapter-interface-contract-replay CONTRACT_ID` | Replay an adapter interface contract artifact | No | Yes | No |
| `atlas research provider-adapter-interface-contract-summary RUN_ID` | Summarize adapter interface contract for a run | No | Yes | No |
| `atlas research provider-adapter-interface-contract-doctor` | Run a read-only diagnostic across adapter interface contracts | No | Yes | No |
| `atlas research provider-adapter-disabled-smoke CONTRACT_ID` | Run a disabled adapter smoke test | No | Yes | No |
| `atlas research provider-mock-response-simulate ADAPTER_CONTRACT_ID` | Create a mock provider response simulation artifact | Yes | No | No |
| `atlas research provider-mock-response-list` | List mock response simulation artifacts | No | Yes | No |
| `atlas research provider-mock-response-show SIMULATION_ID` | Show a mock response simulation artifact | No | Yes | No |
| `atlas research provider-mock-response-validate SIMULATION_ID` | Validate a mock response simulation artifact | No | Yes | No |
| `atlas research provider-mock-response-replay SIMULATION_ID` | Replay a mock response simulation artifact | No | Yes | No |
| `atlas research provider-mock-response-summary RUN_ID` | Summarize mock response simulation state for a run | No | Yes | No |
| `atlas research provider-mock-response-doctor RUN_ID` | Run a read-only diagnostic across mock response simulations | No | Yes | No |
| `atlas research provider-mock-response-import-candidate SIMULATION_ID` | Create a mock response import candidate artifact | Yes | No | No |
| `atlas research provider-mock-response-import-candidate-list` | List mock response import candidate artifacts | No | Yes | No |
| `atlas research provider-mock-response-import-candidate-show CANDIDATE_ID` | Show a mock response import candidate artifact | No | Yes | No |
| `atlas research provider-mock-response-import-candidate-validate CANDIDATE_ID` | Validate a mock response import candidate artifact | No | Yes | No |
| `atlas research provider-mock-response-import-candidate-replay CANDIDATE_ID` | Replay a mock response import candidate artifact | No | Yes | No |
| `atlas research provider-mock-response-import-candidate-summary RUN_ID` | Summarize mock response import candidate state for a run | No | Yes | No |
| `atlas research provider-mock-response-import-candidate-doctor RUN_ID` | Run a read-only diagnostic across mock response import candidates | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox IMPORT_CANDIDATE_ID` | Create a mock response review sandbox artifact | Yes | No | No |
| `atlas research provider-mock-response-review-sandbox-list` | List mock response review sandbox artifacts | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox-show SANDBOX_ID` | Show a mock response review sandbox artifact | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox-validate SANDBOX_ID` | Validate a mock response review sandbox artifact | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox-replay SANDBOX_ID` | Replay a mock response review sandbox artifact | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox-summary RUN_ID` | Summarize mock response review sandbox state for a run | No | Yes | No |
| `atlas research provider-mock-response-review-sandbox-doctor RUN_ID` | Run a read-only diagnostic across mock response review sandboxes | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker REVIEW_SANDBOX_ID` | Create a mock response trust decision blocker artifact | Yes | No | No |
| `atlas research provider-mock-response-trust-decision-blocker-list` | List mock response trust decision blocker artifacts | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker-show BLOCKER_ID` | Show a mock response trust decision blocker artifact | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker-validate BLOCKER_ID` | Validate a mock response trust decision blocker artifact | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker-replay BLOCKER_ID` | Replay a mock response trust decision blocker artifact | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker-summary RUN_ID` | Summarize mock response trust decision blocker state for a run | No | Yes | No |
| `atlas research provider-mock-response-trust-decision-blocker-doctor RUN_ID` | Run a read-only diagnostic across mock response trust decision blockers | No | Yes | No |

`list`, `show`, `summary`, `check-artifacts`, `timeline`, `providers`, `provider-credential-boundary-list`, `provider-credential-boundary-show`, `provider-credential-boundary-validate`, `provider-credential-boundary-replay`, `provider-credential-boundary-summary`, `provider-payload-preview-list`, `provider-payload-preview-show`, `provider-payload-preview-validate`, `provider-payload-preview-replay`, `provider-payload-preview-summary`, `provider-response-intake-policy-list`, `provider-response-intake-policy-show`, `provider-response-intake-policy-validate`, `provider-response-intake-policy-replay`, `provider-response-intake-policy-summary`, `provider-request-response-pairing-list`, `provider-request-response-pairing-show`, `provider-request-response-pairing-validate`, `provider-request-response-pairing-replay`, `provider-request-response-pairing-summary`, `provider-request-response-pairing-doctor`, `provider-response-schema-contract-list`, `provider-response-schema-contract-show`, `provider-response-schema-contract-validate`, `provider-response-schema-contract-replay`, `provider-response-schema-contract-summary`, `provider-response-schema-contract-doctor`, `provider-response-review-result-list`, `provider-response-review-result-show`, `provider-response-review-result-validate`, `provider-response-review-result-replay`, `provider-response-review-result-summary`, `provider-response-review-result-doctor`, `provider-execution-unlock-state-list`, `provider-execution-unlock-state-show`, `provider-execution-unlock-state-validate`, `provider-execution-unlock-state-replay`, `provider-execution-unlock-state-summary`, `provider-execution-unlock-state-doctor`, `provider-adapter-interface-contract-list`, `provider-adapter-interface-contract-show`, `provider-adapter-interface-contract-validate`, `provider-adapter-interface-contract-replay`, `provider-adapter-interface-contract-summary`, `provider-adapter-interface-contract-doctor`, `provider-adapter-disabled-smoke`, `provider-mock-response-list`, `provider-mock-response-show`, `provider-mock-response-validate`, `provider-mock-response-replay`, `provider-mock-response-summary`, and `provider-mock-response-doctor` are read-only. `run`, `plan`, `verify`, `evaluate`, `prompt`, `simulate-provider`, `review-response`, `dossier`, `provider-credential-boundary`, `provider-payload-preview`, `provider-response-intake-policy`, `provider-request-response-pairing`, `provider-response-schema-contract`, `provider-response-review-result`, and `provider-execution-unlock-state` write local artifacts only. None of them touch live trading.
