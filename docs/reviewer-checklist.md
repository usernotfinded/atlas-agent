...
- [ ] Final human review release-readiness audit is deterministic, offline, non-executable, audits the CAND-001 through CAND-005 paper human review chain, and produces a planning-only Go/No-Go dossier for a future separately owner-authorized GitHub-only cutover; docs/checker/tests are present ([docs/releases/v0.6.15-final-readiness-audit.md](releases/v0.6.15-final-readiness-audit.md), `scripts/check_v0615_final_readiness_audit.py`, `tests/test_v0615_final_readiness_audit.py`)
- [ ] `docs/releases/v0.6.15-plan.md`, `docs/releases/v0.6.15-candidates.md`, and `docs/releases/v0.6.15-candidates.json` are planning-only and list CAND-001, CAND-002, CAND-003, CAND-004, CAND-005, and CAND-006 without claiming v0.6.15 is released
