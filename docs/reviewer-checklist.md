...
- [ ] `docs/releases/v0.6.15-plan.md`, `docs/releases/v0.6.15-candidates.md`, and `docs/releases/v0.6.15-candidates.json` are planning-only and list CAND-001, CAND-002, CAND-003, and CAND-004 without claiming v0.6.15 is released
