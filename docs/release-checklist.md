...
```bash
./scripts/smoke_release_tag.sh v0.5.8-rc4
```
...
- `python3.11 scripts/check_v058_rc4_cutover.py` — v0.5.8rc4 cutover verification (supports both pre-tag and post-tag states; does not tag or publish)
