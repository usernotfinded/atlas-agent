...
```bash
./scripts/smoke_release_tag.sh v0.5.7.dev8 --full
```
...
git commit -m "Bump version to v0.5.7.dev8"
git push origin main
git tag -a v0.5.7.dev8 -m "Atlas Agent v0.5.7.dev8"
git push origin v0.5.7.dev8
```
