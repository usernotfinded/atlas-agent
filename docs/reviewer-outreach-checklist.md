...
- [ ] `main` source version is `0.6.10` and the public GitHub release is `v0.6.10`.
...
- [ ] README current status is clear (`v0.6.11` latest stable; `v0.6.10` historical; `v0.6.9` historical; `v0.6.8` is historical).
