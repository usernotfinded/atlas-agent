...
- [ ] `main` remains at `0.5.8.dev0` (no premature version bump).
- [ ] `v0.5.7` tag remains untouched (no tag recreation or force-push).
...
- [ ] README current development status is clear (`0.5.8.dev0`, post-v0.5.7).
