...
The v0.6.3 hotfix has been delivered through the `v0.6.3` versioned GitHub release. The v0.6.2, v0.6.1, and v0.6.0 releases are historical. v0.6.4 planning is in progress and not yet prepared or tagged.
