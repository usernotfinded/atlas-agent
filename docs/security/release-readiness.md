...
The security hardening and maintenance workflow changes have been delivered through the `v0.5.9.4` versioned GitHub release so auto-updater users can receive the current public release identity.
...
For v0.5.9.4, the expected public GitHub release is `v0.5.9.4`.
