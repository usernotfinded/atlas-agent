...
The v0.6.26 public GitHub release is the current stable version. v0.6.25 and earlier releases are historical.
...
For v0.6.26, the public GitHub release is `v0.6.26`. v0.6.25 is historical.
