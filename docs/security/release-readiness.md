...
The v0.6.22 public GitHub release is the current stable version. v0.6.21 and earlier releases are historical.
...
For v0.6.22, the public GitHub release is `v0.6.22`. v0.6.21 is historical.
