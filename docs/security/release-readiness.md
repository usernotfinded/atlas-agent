...
The v0.6.20 public GitHub release is the current stable version. v0.6.19 and earlier releases are historical.
...
For v0.6.20, the public GitHub release is `v0.6.20`. v0.6.19 is historical.
