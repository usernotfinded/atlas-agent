...
The v0.6.27 public GitHub release is the current stable version. v0.6.26 and earlier releases are historical.
...
For v0.6.27, the public GitHub release is `v0.6.27`. v0.6.26 is historical.
