...
- [v0.6.15 Planning Seed](../releases/v0.6.15-plan.md) — next-line planning notes; CAND-001 Paper Human Review Pack, CAND-002 Paper Human Review Ledger, and CAND-003 Paper Human Review Policy Simulator are proposed as deterministic, offline, non-executable review artifacts with no live trading, broker, provider, notification, order, or real human approval side effects
