...
- Current public release: `v0.6.21` (tagged)
- Previous public release: `v0.6.20`
- Source package version on `main`: `0.6.21`
- GitHub release: `v0.6.21` (current public)
- Next planning line: `v0.6.22`
- Public v0.6.21: current public — [v0.6.21 Trust and Release Status](v0.6.21-status.md)
...
- Current public release status: [v0.6.21 Trust and Release Status](v0.6.21-status.md) (current public)
- Previous release status: [v0.6.20 Trust and Release Status](v0.6.20-status.md) (historical)
...
- Current public release notes: [docs/releases/v0.6.21.md](../releases/v0.6.21.md) (current public)
- Previous release notes: [docs/releases/v0.6.20.md](../releases/v0.6.20.md) (historical)
...
Auto-updater delivery for `v0.6.21` is verified against the GitHub release/tag.
Auto-updater delivery for `v0.6.20` and earlier remains verified.
...
- Tag: `v0.6.21` (created and pushed)
...
- PyPI was not published
- Package version in source metadata: `0.6.21`
- Auto-updater delivery: verified for `v0.6.21`; verified for `v0.6.20`; verified for `v0.6.19`; verified for `v0.6.18`; verified for `v0.6.17`; verified for `v0.6.16`; verified for `v0.6.15`; verified for `v0.6.14`; verified for `v0.6.13`

## What Is Ready

- Public v0.6.21 release notes and release status documentation (current public).
...
- PyPI was not published for `v0.6.1` through `v0.6.21`.
- `v0.6.22` is the next planning line; no candidates are selected.
...
- [v0.6.21 Release Notes](../releases/v0.6.21.md) (current public)
- [v0.6.21 Trust and Release Status](v0.6.21-status.md) (current public)
