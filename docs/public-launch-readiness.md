...
- Version on `main` is `0.6.23`; latest stable public GitHub release is `v0.6.23`. `v0.6.22` and earlier releases are historical.
- `v0.6.23` is the current public GitHub-only release; `v0.6.24` is the next planning line.
...
- [v0.6.22 Planning Seed](./releases/v0.6.22-plan.md) records the historical planning seed for the now-historical `v0.6.22`.
- [v0.6.23 Planning Seed](./releases/v0.6.23-plan.md) records the historical planning seed for the now-released `v0.6.23`.
- [v0.6.24 Planning Seed](./releases/v0.6.24-plan.md) seeds the next planning line and does not authorize a release.
