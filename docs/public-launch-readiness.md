...
Atlas Agent is a **v0.6.24 public release for sandbox/paper/preflight workflows**. It is ready to be shown publicly for review, evaluation, and contribution, but it is **not a live-trading-ready product**. The current tagged public GitHub release is `v0.6.24`; `v0.6.23` and earlier releases are historical.

The source package version on `main` is `0.6.24`. `v0.6.24` is tagged and released on GitHub only; PyPI was not published.
...
- `docs/releases/v0.6.24.md` present — current public release notes
- `docs/trust/v0.6.24-status.md` present — current public trust status
...
- Version on `main` is `0.6.24`; latest stable public GitHub release is `v0.6.24`. `v0.6.23` and earlier releases are historical.
- `v0.6.24` is the current public GitHub-only release; `v0.6.25` is the next planning line.
...
- [v0.6.23 Planning Seed](./releases/v0.6.23-plan.md) records the historical planning seed for the now-historical `v0.6.23`.
- [v0.6.24 Planning Seed](./releases/v0.6.24-plan.md) records the historical planning seed for the now-released `v0.6.24`.
- [v0.6.25 Planning Seed](./releases/v0.6.25-plan.md) seeds the next planning line and does not authorize a release.
