...
- Version on `main` is `0.6.11`; latest stable public GitHub release is `v0.6.11`. v0.6.10, v0.6.9, v0.6.8, v0.6.7, v0.6.6, v0.6.5, v0.6.4, v0.6.3, v0.6.2, v0.6.1, and v0.6.0 are historical.
