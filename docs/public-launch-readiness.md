...
Atlas Agent is a **v0.6.2 release for sandbox/paper/preflight workflows**. It is ready to be shown publicly for review, evaluation, and contribution, but it is **not a live-trading-ready product**. The latest tagged public GitHub release is `v0.6.2`; `v0.6.1` and `v0.6.0` are historical.
...
- Version on `main` is `0.6.2`; latest stable public GitHub release is `v0.6.2`. v0.6.1 and v0.6.0 are historical.
