...
Atlas Agent is a **v0.6.19 public release for sandbox/paper/preflight workflows**. It is ready to be shown publicly for review, evaluation, and contribution, but it is **not a live-trading-ready product**. The current tagged public GitHub release is `v0.6.19`; `v0.6.18` and earlier releases are historical.

The source package version on `main` is `0.6.19`. `v0.6.19` is tagged and released on GitHub only; PyPI was not published.
...
- `docs/releases/v0.6.19.md` present — current public release notes
- `docs/trust/v0.6.19-status.md` present — current public trust status
...
- Version on `main` is `0.6.19`; latest stable public GitHub release is `v0.6.19`. `v0.6.18` and earlier releases are historical.
- `v0.6.19` is the current public GitHub-only release; `v0.6.20` is the next planning line.
...
- [v0.6.19 Planning Seed](./releases/v0.6.19-plan.md) seeds the next planning line and does not authorize a release.
