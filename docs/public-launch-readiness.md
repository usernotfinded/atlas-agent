...
Atlas Agent is a **v0.6.27 public release for sandbox/paper/preflight workflows**. It is ready to be shown publicly for review, evaluation, and contribution, but it is **not a live-trading-ready product**. The current tagged public GitHub release is `v0.6.27`; `v0.6.26` and earlier releases are historical.

The source package version on `main` is `0.6.27`. `v0.6.27` is tagged and released on GitHub only; PyPI was not published.
...
- `python3.11 scripts/check_v0615_post_release_hygiene.py` — historical v0.6.15 GitHub-only public-release hygiene remains valid
...
- `python3.11 scripts/check_paper_human_review_policy.py` — v0.6.15 CAND-003 paper human review policy gate is safe and present
- `python3.11 -m pytest tests/test_paper_human_review_policy.py -q` — paper human review policy tests pass
- `bash scripts/demo_paper_human_review_policy.sh` — paper human review policy demo runs offline without credentials, network, or broker contact
...
- `docs/releases/v0.6.27.md` present — current public release notes
- `docs/trust/v0.6.27-status.md` present — current public trust status
- `docs/releases/v0.6.26.md` present — historical release notes
- `docs/trust/v0.6.26-status.md` present — historical trust status
- `docs/releases/v0.6.25.md` present — historical release notes
- `docs/trust/v0.6.25-status.md` present — historical trust status
- `docs/releases/v0.6.24.md` present — historical release notes
- `docs/trust/v0.6.24-status.md` present — historical trust status
- `docs/releases/v0.6.21.md` present — historical release notes
- `docs/trust/v0.6.21-status.md` present — historical trust status
...
- `docs/releases/v0.6.15.md` present — v0.6.15 release notes (historical)
- `docs/trust/v0.6.15-status.md` present — v0.6.15 trust status (historical)
...
- Version on `main` is `0.6.27`; latest stable public GitHub release is `v0.6.27`. `v0.6.26` and earlier releases are historical.
- `v0.6.27` is the current public GitHub-only release; `v0.6.28` is the next planning line.
...
- [v0.6.24 Planning Seed](./releases/v0.6.24-plan.md) records the historical planning seed for the now-historical `v0.6.24`.
- [v0.6.25 Planning Seed](./releases/v0.6.25-plan.md) records the historical planning seed for the now-released `v0.6.25`.
- [v0.6.26 Planning Seed](./releases/v0.6.26-plan.md) records the historical planning seed for the now-released `v0.6.26`.
- [v0.6.27 Planning Seed](./releases/v0.6.27-plan.md) seeds the next planning line and does not authorize a release.
