...
GITHUB_ACTIONS_WORKFLOW_PATH = Path(".github") / "workflows" / "atlas-routines.yml"
SCHEDULED_ROUTINES = {
...
def render_github_actions_workflow() -> str:
    ...
    return f"""name: Atlas Agent Paper Routines
...
env:
  ...
  # ATLAS_RESEARCH_API_KEY: ${{{{ secrets.ATLAS_RESEARCH_API_KEY }}}}
