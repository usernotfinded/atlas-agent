...
@research_envelope("provider-mock-response-simulate")
def handle_provider_mock_response_simulate(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-list")
def handle_provider_mock_response_list(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-show")
def handle_provider_mock_response_show(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-validate")
def handle_provider_mock_response_validate(context: CLIContext, ws: Path) -> int:
    args = context.args
    from atlas_agent.research.provider_mock_response_simulation import (
        find_provider_mock_response_simulation_by_id,
...
@research_envelope("provider-mock-response-replay")
def handle_provider_mock_response_replay(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-summary")
def handle_provider_mock_response_summary(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-doctor")
def handle_provider_mock_response_doctor(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate")
def handle_provider_mock_response_import_candidate(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate-list")
def handle_provider_mock_response_import_candidate_list(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate-show")
def handle_provider_mock_response_import_candidate_show(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate-validate")
def handle_provider_mock_response_import_candidate_validate(context: CLIContext, ws: Path) -> int:
    args = context.args
    from atlas_agent.research.provider_mock_response_import_candidate import (
        find_provider_mock_response_import_candidate_by_id,
...
@research_envelope("provider-mock-response-import-candidate-replay")
def handle_provider_mock_response_import_candidate_replay(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate-summary")
def handle_provider_mock_response_import_candidate_summary(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-import-candidate-doctor")
def handle_provider_mock_response_import_candidate_doctor(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox")
def handle_provider_mock_response_review_sandbox(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox-list")
def handle_provider_mock_response_review_sandbox_list(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox-show")
def handle_provider_mock_response_review_sandbox_show(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox-validate")
def handle_provider_mock_response_review_sandbox_validate(context: CLIContext, ws: Path) -> int:
    args = context.args
    from atlas_agent.research.provider_mock_response_review_sandbox import (
        find_provider_mock_response_review_sandbox_by_id,
...
@research_envelope("provider-mock-response-review-sandbox-replay")
def handle_provider_mock_response_review_sandbox_replay(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox-summary")
def handle_provider_mock_response_review_sandbox_summary(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-review-sandbox-doctor")
def handle_provider_mock_response_review_sandbox_doctor(context: CLIContext, ws: Path) -> int:
    args = context.args
...
@research_envelope("provider-mock-response-trust-decision-blocker")
...
@research_envelope("provider-mock-response-trust-decision-blocker-list")
def handle_provider_mock_response_trust_decision_blocker_list(context: CLIContext, ws: Path) -> int:
    ...
    if args.json:
        print_json({"ok": True, "status": "provider_mock_response_trust_decision_blockers_listed", "items": items})
    else:
...
@research_envelope("provider-mock-response-trust-decision-blocker-show")
def handle_provider_mock_response_trust_decision_blocker_show(context: CLIContext, ws: Path) -> int:
    args = context.args
    ...
    if artifact_path is None:
        if args.json:
            print_json({"ok": False, "status": "blocker_not_found"})
        else:
...
@research_envelope("provider-mock-response-trust-decision-blocker-validate")
def handle_provider_mock_response_trust_decision_blocker_validate(context: CLIContext, ws: Path) -> int:
    args = context.args
    from atlas_agent.research.provider_mock_response_trust_decision_blocker import (
        find_provider_mock_response_trust_decision_blocker_by_id,
...
@research_envelope("provider-mock-response-trust-decision-blocker-replay")
...
@research_envelope("provider-mock-response-trust-decision-blocker-summary")
...
@research_envelope("provider-mock-response-trust-decision-blocker-doctor")
...
@research_envelope("provider-mock-response-final-safety-seal")
...
@research_envelope("provider-mock-response-final-safety-seal-list")
def handle_provider_mock_response_final_safety_seal_list(context: CLIContext, ws: Path) -> int:
    ...
    if args.json:
        print_json({"ok": True, "status": "provider_mock_response_final_safety_seals_listed", "items": items})
    else:
...
@research_envelope("provider-mock-response-final-safety-seal-show")
def handle_provider_mock_response_final_safety_seal_show(context: CLIContext, ws: Path) -> int:
    args = context.args
    ...
    if artifact_path is None:
        if args.json:
            print_json({"ok": False, "status": "seal_not_found"})
        else:
...
@research_envelope("provider-mock-response-final-safety-seal-validate")
def handle_provider_mock_response_final_safety_seal_validate(context: CLIContext, ws: Path) -> int:
    args = context.args
    from atlas_agent.research.provider_mock_response_final_safety_seal import (
        find_provider_mock_response_final_safety_seal_by_id,
...
@research_envelope("provider-mock-response-final-safety-seal-replay")
...
@research_envelope("provider-mock-response-final-safety-seal-summary")
...
@research_envelope("provider-mock-response-final-safety-seal-doctor")
