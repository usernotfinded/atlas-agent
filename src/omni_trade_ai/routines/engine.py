...
from omni_trade_ai.routines.context_loader import load_routine_context
from omni_trade_ai.routines.git_sync import GitSync, GitSyncError
from omni_trade_ai.routines.lock import routine_lock
from omni_trade_ai.routines.memory_writer import append_memory, overwrite_memory
from omni_trade_ai.routines.routine_result import RoutineResult
...
def run_routine(
    ...
    *,
    mode: str,
    config: OmniTradeConfig | None = None,
...
def _workspace_dir(config: OmniTradeConfig) -> Path:
