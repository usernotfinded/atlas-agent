...
class OmniTradeConfig:
    ...
    git_commit_author_name: str = "OmniTradeAI Agent"
    git_commit_author_email: str = "omni-trade-ai@example.local"

    @classmethod
    def from_env(cls) -> OmniTradeConfig:
