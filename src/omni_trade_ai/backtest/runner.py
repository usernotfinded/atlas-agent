...
from omni_trade_ai.backtest.metrics import BacktestMetrics, TradeRecord, calculate_metrics
from omni_trade_ai.backtest.report import write_backtest_report
...
def _simulate(bars: list[Bar], config: OmniTradeConfig) -> BacktestResult:
